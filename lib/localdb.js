...
db.serialize(function (){
	...
	LocalDB.prototype.restoreInventory = function (playerName, dateStamp, callback){
		var date = "'" + dateStamp + "'"
		var name = "'" + playerName + "'"
		var sql = "SELECT PlayerName, Inventory FROM player_states WHERE PlayerName = ";
		var query = sql.concat(name + ' AND dateStamp = ' + date);
		console.log(query);
